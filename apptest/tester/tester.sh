...
tctl install manifest management-plane-operator --registry=$REPO | kubectl delete -f - --ignore-not-found
...
kubectl delete -f /data-test/artifacts/cert-manager.yaml
kubectl delete -f /data-test/artifacts/configmap.yaml
kubectl delete -f /data-test/artifacts/operator-service-account-rbac.yaml
kubectl delete -f /data-test/artifacts/postgres-operator.yaml
kubectl delete -f /data-test/artifacts/api-service.yaml
kubectl delete -f /data-test/artifacts/pgsql.yaml
kubectl delete -f /data-test/artifacts/crds.yaml
kubectl delete -f /data-test/artifacts/operator.yaml
kubectl delete -f /data-test/artifacts/elastic.yaml
